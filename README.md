...
3. **Host settings**: set `DJANGO_ALLOWED_HOSTS` OR `RAILWAY_PUBLIC_DOMAIN` (this project also auto-allows `healthcheck.railway.app` for Railway probes).
...
- `DJANGO_ALLOWED_HOSTS=<your-domain>` (Railway healthcheck host is auto-allowed)
