...
CSRF_TRUSTED_ORIGINS = env.list(
    ...
    default=[f"https://{RAILWAY_PUBLIC_DOMAIN}"] if RAILWAY_PUBLIC_DOMAIN else ["https://example.com"],
)

# ── CORS ──────────────────────────────────────────────────────────────────────
CORS_ALLOWED_ORIGINS = env.list(
    "CORS_ALLOWED_ORIGINS",
    default=["https://hrms-forntend.netlify.app"],
)
...
# ── EMAIL (console — no Anymail env vars needed) ──────────────────────────────
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", default="Simper HRMS <noreply@example.com>")
SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[Simper HRMS] ")
...
SPECTACULAR_SETTINGS["SERVERS"] = (
    ...
    else [{"url": "https://example.com", "description": "Production server"}]
)
...
LOGGING = {
    ...
    "loggers": {
        # Silence Railway healthcheck DisallowedHost noise
