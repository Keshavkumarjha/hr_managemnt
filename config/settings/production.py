...
configured_allowed_hosts = env.list("DJANGO_ALLOWED_HOSTS", default=DEFAULT_ALLOWED_HOSTS)
ALLOWED_HOSTS = list(dict.fromkeys([*configured_allowed_hosts, "healthcheck.railway.app"]))
...
# Allow URL customization for reverse proxies/CDNs while keeping sane defaults.
STATIC_URL = env("DJANGO_STATIC_URL", default=STATIC_URL)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="hr managemnt <noreply@example.com>",
)
